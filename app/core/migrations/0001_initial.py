# Generated by Django 4.0.10 on 2023-12-06 22:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(choices=[('processing', 'Processing'), ('cancelled', 'Cancelled'), ('ready', 'Ready'), ('error', 'Error'), ('downloading', 'Downloading')], max_length=255)),
