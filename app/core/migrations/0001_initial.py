# Generated by Django 4.0.10 on 2024-04-29 10:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='converted_files_related', to='core.data')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='converted_data', to='core.file'),
        ),
        migrations.AddField(
            model_name='data',
